...
def call(body) {
    ...
    body()
    def failure = false
    def repo_url = "https://subversion.assembla.com/svn/${config.path}/trunk/${config.repo}"
    node {
GitBuildTask task = new GitBuildTask(env)
    ...
    sleep 5
			dir("./${config.name}") {
                ...
                def checkoutResult = git credentialsId: '60c19ca5-84bb-4508-a665-0c7895d3031b', url: "https://sadhasivim@bitbucket.org/sadhasivim/${config.gitrepo}.git", changeLog:true
