...
def call(body) {
    ...
    node {
            ...
            //Checkout the latest code
			 ...
			 stage('code checkout'){
                def checkoutResult = git credentialsId: '60c19ca5-84bb-4508-a665-0c7895d3031b', url: "https://sadhasivim@bitbucket.org/GSIHTeam/configurationautomation.git", changeLog:true
                        ...
                        buildEnvVars.add("JAVA_HOME=${tool 'jdk8u121'}")
						   ...
						   withEnv(buildEnvVars) {
						    def clean="mvn clean install"
												 ...
												 def mvnJsonFormatChangeCmd="mvn exec:java -Dspecification.operation=\"createRequiredJsonFormat\""
